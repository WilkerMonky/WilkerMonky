<div align="center">
  <img src="./assets/wilker-fullstack-banner.png" width="100%" alt="WilkerMonky profile banner with purple aura and subtle technology interfaces." />
  ...
  [![Português](https://img.shields.io/badge/Português-030108?style=for-the-badge&logoColor=F5F3FF&color=7C3AED)](./README.pt-BR.md)
  ...
  <strong>Weslley Wilker Oliveira da Costa</strong> • Brasília, DF - Brazil
</div>
...
| Backend Engineering | Frontend & Data | Software Quality |
| :--- | :--- | :--- |
| Java, Spring Boot, C#, ASP.NET, REST APIs, business rules, integrations and layered architecture. | React, JavaScript, PostgreSQL, MySQL, SQL Server, data modeling and query optimization. | SOLID, Clean Code, Design Patterns, JUnit, Mockito, unit testing, documentation and API performance. |

---

<img src="./assets/featured-projects-banner.png" width="100%" alt="Featured projects banner with purple energy routes connecting frontend, APIs, services and data." />

## Featured Projects

### IGRIS

Computer Science capstone ecosystem for academic allocation and optimization. It combines a Spring Boot backend, React frontend and specialized services in Go and Python.

**Stack:** Java • Spring Boot • React • TypeScript • PostgreSQL • Go • Python

[Organization](https://github.com/igris-project) • [Backend](https://github.com/igris-project/igris-backend) • [Frontend](https://github.com/igris-project/igris-frontend) • [Rocket](https://github.com/igris-project/igris-rocket-service) • [Morpheus](https://github.com/igris-project/igris-morpheus-service)

### PGP Academy

Gamified programming platform developed collaboratively. My contribution included the initial backend in C# and ASP.NET, database modeling, requirements and technical planning.

**Stack:** C# • ASP.NET • Relational Database

### Mione

Academic tutoring management platform with public backend, frontend and documentation repositories. The public docs describe a Java/Spring Boot/PostgreSQL backend and a React/Vite/TypeScript frontend.
...
> Reliable software is built to be understood, maintained and improved.
