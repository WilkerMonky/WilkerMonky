...
| `engineering-focus-banner.png` | 1600 x 500 | Engineering focus divider |
...
- Use the purple and black palette in [art direction](./art-direction.md) and avoid adding animated or visitor-count widgets.
